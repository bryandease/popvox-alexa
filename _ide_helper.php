...
namespace {
    ...
    class AlexaRoute extends \Develpr\AlexaApp\Facades\AlexaRouter{
        ...
        public static function resource($name, $controller, $options = array()){
            //Method inherited from \Illuminate\Routing\Router            
            \Develpr\AlexaApp\Http\Routing\AlexaRouter::resource($name, $controller, $options);
        }
        ...
        public static function group($attributes, $callback){
            //Method inherited from \Illuminate\Routing\Router            
            \Develpr\AlexaApp\Http\Routing\AlexaRouter::group($attributes, $callback);
        }
        ...
        public static function mergeGroup($new, $old){
            //Method inherited from \Illuminate\Routing\Router            
            return \Develpr\AlexaApp\Http\Routing\AlexaRouter::mergeGroup($new, $old);
        }
        ...
        public static function resolveMiddlewareClassName($name){
            //Method inherited from \Illuminate\Routing\Router            
            return \Develpr\AlexaApp\Http\Routing\AlexaRouter::resolveMiddlewareClassName($name);
        }
        ...
        public static function middleware($name, $class){
            //Method inherited from \Illuminate\Routing\Router            
            return \Develpr\AlexaApp\Http\Routing\AlexaRouter::middleware($name, $class);
        }
        ...
        public static function createClassBinding($binding){
            //Method inherited from \Illuminate\Routing\Router            
            return \Develpr\AlexaApp\Http\Routing\AlexaRouter::createClassBinding($binding);
        }
        ...
        public static function is(){
            //Method inherited from \Illuminate\Routing\Router            
            return \Develpr\AlexaApp\Http\Routing\AlexaRouter::is();
        }
        ...
        public static function currentRouteNamed($name){
            //Method inherited from \Illuminate\Routing\Router            
            return \Develpr\AlexaApp\Http\Routing\AlexaRouter::currentRouteNamed($name);
        }
        ...
        public static function uses(){
            //Method inherited from \Illuminate\Routing\Router            
            return \Develpr\AlexaApp\Http\Routing\AlexaRouter::uses();
        }
